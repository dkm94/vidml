...
export const introduction: string[] = [
	'I\'m a passionate fashion illustrator with a keen eye for capturing the essence of the most iconic runway moments. My journey into the realm of art and design began with a childhood full of dreams and a fascination for the world of fashion. From the early sketches of elegant dresses in my sketchbooks to the refined illustrations I create today, I\'ve embarked on a creative odyssey inspired by the grandeur of haute couture.',
